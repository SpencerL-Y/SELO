...
if "--static" in  is_static:
    print("cd build && rm -rf * && cmake .. -GNinja -DBUILD_TESTING=On -DENABLE_REGRESSION=On $ESBMC_CLANG  -DBUILD_STATIC=${ESBMC_STATIC:-ON} -DENABLE_Z3_SLHV=On -DZ3_DIR=" + your_z3_lib_path + " -DCMAKE_INSTALL_PREFIX:PATH=" + your_release_path)
    ...
    print("cd build && rm -rf * && cmake .. -GNinja -DBUILD_TESTING=On -DENABLE_REGRESSION=On $ESBMC_CLANG  -DENABLE_Z3_SLHV=On -DZ3_DIR=" + your_z3_lib_path + "   -DCMAKE_INSTALL_PREFIX:PATH=" + your_release_path)
